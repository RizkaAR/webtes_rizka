...
.crsl{
	background-image: none; margin-top:50;margin-right:-200;
}
.imglogo
{
	width:20%;
...
@media (max-width: 767px) {
  ...
  .carousel-col                { width: 50%; }
	...
	.crsl{
		background-image: none; margin-top:40;margin-right:-5;
	}
	.tab_menu_co
	{
		z-index:1;
		...
		<div class="row">
			<div id="banner-carousel" class="carousel slide" data-ride="carousel">
				<div class="header_menu ">
					<div class="imglogo">
						<img src="logo_kasirpintar.png" style="width: 80%">
					</div>
					
					<div class="tab_menu ">
						<div class="col-xs-12 menu" style="z-index:2;position:relative;">
			...
			<div class="why">
				<center>
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 w_left">
				 ...
				 <div class="row">
				    <div class="col-xs-11 col-md-10 col-centered">
						...
						<div id="carousel" class="carousel slide" data-ride="carousel" data-type="multi" data-interval="2500">
							...
							<div class="right carousel-control crsl">
